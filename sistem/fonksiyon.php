...
function takip()
{
    ...
    if (@$_SERVER['HTTP_REFERER']) $bironceki = $_SERVER['HTTP_REFERER'];
    else $bironceki = 'boş';
    ...
    $veri->execute(array($kullaniciip, $gecerliadres, $bironceki, $kullanicidil,$zaman));
